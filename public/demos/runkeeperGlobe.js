  ...
  function runkeeperGlobe(el){
    ...
    // slide.addEventListener('shown', function(){
      ...
      new TWEEN.Tween(view)
        ...
        //     .to({radius: 4000, theta: Math.PI*2}, 3000)
        //     .onUpdate(renderView)
        // )
        .start()
    ...
    //   new TWEEN.Tween(view)
    //     .easing( TWEEN.Easing.Quadratic.InOut )
    //     .to({radius: 4000, theta: -Math.PI*2}, 14000)
    //     .onUpdate(renderView)
    //   .start()
    //
    // },
    ...
    function(){
      ...
      new TWEEN.Tween(view)
        .easing( TWEEN.Easing.Quadratic.InOut )
        .to({radius: 80000, phi:0.8, theta: 1.3}, 4000)
        .onUpdate(renderView)
      .start()
      ...
      new TWEEN.Tween(view)
        ...
        .chain(
          new TWEEN.Tween(view)
            .easing( TWEEN.Easing.Quadratic.InOut )
            .to({
              radius: 2345.68133310664, phi: 0.3, theta: 5
            }, 4000)
            .onUpdate(renderView)
        )
